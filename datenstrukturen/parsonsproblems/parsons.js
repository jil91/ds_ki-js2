(function ($, _) { // wrap in anonymous function to not show some helper variables
  ...
  var translations = {
    ...
    de: {
      ...
      no_matching_close: function (lineNro, block) {
        return "Block " + block + ", der in Zeile " + lineNro + "definiert wurde, wurde nicht korrekt beendet.";
      },
      block_close_mismatch: function (closeLine, closeBlock, openLine, inBlock) {
        return "Der Block " + closeBlock + " kann in Zeile " + closeLine + " nicht beendet werden, während sich der Block " + inBlock + " noch in Zeile " + openLine + " befindet.";
      },
      block_structure: function (lineNro) {
        return "Das hervorgehobene Fragment " + lineNro + " gehört zu einem falschen Block (d.h. Einrückung).";
      },
      unittest_error: function (errormsg) {
        return "<span class='msg'>Fehler beim Parsen/Ausführen deines Programms</span><br/> <span class='errormsg'>" + errormsg + "</span>";
      },
      unittest_output_assertion: function (expected, actual) {
        return "Erwartete Ausgabe: <span class='expected output'>" + expected + "</span>" +
          "Ausgabe deines Programms: <span class='actual output'>" + actual + "</span>";
      },
      unittest_assertion: function (expected, actual) {
        return "Erwarteter Wert: <span class='expected'>" + expected + "</span><br>" +
          "Tatsächlicher Wert: <span class='actual'>" + actual + "</span>";
      },
      variabletest_assertion: function (varname, expected, actual) {
        return "Erwarteter Wert der Variable " + varname + ": <span class='expected'>" + expected + "</span><br>" +
          "Tatsächlicher Wert: <span class='actual'>" + actual + "</span>";
      }
    }
